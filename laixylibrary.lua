...
local Utility = {}
local Objects = {}
function Ege:DraggingEnabled(frame, parent)
...
function Ege.CreateLib(kavName, themeList)
    ...
    elseif themeList == "EgeTheme" then
    ...
    Ege:DraggingEnabled(MainHeader, Main)
    ...
    function Ege:ChangeColor(prope,color)
    ...
    function Tabs:NewTab(tabName)
        ...
        coroutine.wrap(function()
            ...
            function Elements:NewTextBox(tname, tTip, callback)
                ...
                moreInfo.Name = "TipMore"
                moreInfo.Parent = infoContainer
                moreInfo.BackgroundColor3 = Color3.fromRGB(0, 47, 255)
                moreInfo.Position = UDim2.new(0, 0, 2, 0)
                moreInfo.Size = UDim2.new(0, 353, 0, 33)
                moreInfo.ZIndex = 9
                moreInfo.Font = Enum.Font.GothamSemibold
